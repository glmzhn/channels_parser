...
class FreshChangeAdminsForbidden(BadRequest):
    """You can't change administrator settings in this chat because your sessions was logged-in recently"""
...
class SessionTooFresh(BadRequest):
    """You can't do this action because the current sessions was logged-in recently"""
...
class TakeoutRequired(BadRequest):
    """The method must be invoked inside a takeout sessions"""
    ID = "TAKEOUT_REQUIRED"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
