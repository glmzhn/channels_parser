...
class AuthKeyDuplicated(NotAcceptable):
    """The same authorization key (sessions file) was used in more than one place simultaneously. You must delete your sessions file and log in again with your phone number or bot token"""
...
class FreshChangePhoneForbidden(NotAcceptable):
    """You can't change your phone number because your sessions was logged-in recently"""
