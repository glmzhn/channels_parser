...
class ExportSessionString:
    async def export_session_string(
        ...
        """Export the current authorized sessions as a serialized string.

        Session strings are useful for storing in-memory authorized sessions in a portable, serialized string.
        More detailed information about sessions strings can be found at the dedicated page of
        :doc:`Storage Engines <../../topics/storage-engines>`.

        Returns:
            ``str``: The sessions serialized into a printable, url-safe string.
